...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220105_feccawp_f1e907188136b8d44203_20220105110249_archive.zip';
	const ARCHIVE_SIZE		 = '22006555';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f1e9071-05110249';
    const SECONDARY_PACKAGE_HASH = '6efba31-05110249';
	const VERSION			 = '1.4.3';
